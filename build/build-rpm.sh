...
neg-pretty-printer)
    ...
    NEG_PRETTY_PRINTER_RPM_NAME="neg-pretty-printer-${V[neg-pretty-printer]}-1.fc43.noarch.rpm"
    if [ -f "/build/rpms/${NEG_PRETTY_PRINTER_RPM_NAME}" ]; then
        ...
        NEG_PP_SOURCE_DIR="${RPM_BUILD_ROOT}/BUILD/neg-pretty-printer-${V[neg-pretty-printer]}"
        ...
        tar -czf "${SOURCES_DIR}/neg-pretty-printer-${V[neg-pretty-printer]}.tar.gz" -C "${RPM_BUILD_ROOT}/BUILD" "neg-pretty-printer-${V[neg-pretty-printer]}"
